...
We can also use RCTD for annotation which is published [here](https://doi.org/10.1038/s41587-021-00830-w). RCTD is able to decompose cell mixtures to accurately annotate spatial datasets.
...
ref <- UpdateSeuratObject(ref)
Idents(ref) <- "celltype"
counts <- LayerData(ref, assay = "RNA", layer = "counts")
...
counts <- LayerData(slide.seq, assay = "Spatial", layer = "counts")
