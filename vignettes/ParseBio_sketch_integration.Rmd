...
```{r, warning=F, message=F}
object <- readRDS("/brahms/hartmana/vignette_data/parse_1m_pbmc.rds")
...
# NOTE change celltype.weight -> sketch.celltype in metadata
...
p2 <- DimPlot(object, reduction = 'umap.full', group.by = 'celltype.weight', label = T, alpha = 0.5) + NoLegend()
p1 + p2
```
