...
```
```{r, fig.width=10, fig.height=6}
p1 <- VlnPlot(obj.comp, features =  "MAIT", group.by = 'disease', slot = 'counts', cols = c("#377eb8", "#e41a1c")) + ylab('relative abundance')
p2 <- VlnPlot(obj.comp, features = 'Plasmablast', group.by = 'disease', slot = 'counts', cols = c("#377eb8", "#e41a1c")) + ylab('relative abundance')
