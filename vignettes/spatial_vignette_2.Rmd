...
```{r analysis}
vizgen.obj <- SCTransform(vizgen.obj, assay = "Vizgen", clip.range = c(-10,10), verbose = FALSE)
vizgen.obj <- RunPCA(vizgen.obj, npcs = 30, features = rownames(vizgen.obj), verbose = FALSE)
vizgen.obj <- RunUMAP(vizgen.obj, dims = 1:30, verbose = FALSE)
vizgen.obj <- FindNeighbors(vizgen.obj, reduction = "pca", dims = 1:30, verbose = FALSE)
vizgen.obj <- FindClusters(vizgen.obj, resolution = 0.3, verbose = FALSE)
```
...
p2 <- ImageDimPlot(vizgen.obj, fov = "hippo", axes = TRUE, border.color = "white", border.size = 0.1, cols = "polychrome")
...
DefaultBoundary(vizgen.obj[["hippo"]]) <- "simplified.segmentations"
p3 <- ImageDimPlot(vizgen.obj, fov = "hippo", axes = TRUE, border.color = "white", border.size = 0.1, cols = "polychrome")
...
```{r, fig.width=11, fig.height=7}
ImageDimPlot(nano.obj, fov = "zoom1", cols = "polychrome")
```

```{r, fig.width=11, fig.height=7}
# note the clouds of TPSAB1 molecules denoting mast cells
ImageDimPlot(nano.obj, fov = "zoom1", cols = "polychrome", alpha = 0.3, molecules = c("KRT17", "IL7R", "TPSAB1"), mols.size = 0.3, nmols = 20000, border.color = "black")
```
