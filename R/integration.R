...
#'
#' Find a set of anchors between a group of \code{\link{Seurat}} objects. 
#' These  anchors can later be used to integrate the objects using the
#' \code{\link{IntegrateData}} function.
#'
#' @param object.list A list of \code{\link{Seurat}} objects between which to find anchors for
...
#'
#' @param anchorset An \code{\link{AnchorSet}} object generated by \code{\link{FindIntegrationAnchors}}
...
#'    \item{A vector of \code{\link{DimReduc}} objects, specifying the object to use for each object in the integration}
...
#' @param verbose Print progress bars and output
#'
#' @return Returns a \code{\link{Seurat}} object with a new integrated \code{\link{Assay}}
#'
#' @export
#'
...
#'
#' @param anchorset An \code{\link{AnchorSet}} object generated by \code{\link{FindTransferAnchors}}
...
#'    \item{custom DimReduc: User provided \code{\link{DimReduc}} object computed on the query
#'    cells}
#' }
...
#'
#' @return If \code{refdata} is a vector, returns a dataframe with label predictions.
#' If \code{refdata} is a matrix, returns an Assay object where the imputed data has
