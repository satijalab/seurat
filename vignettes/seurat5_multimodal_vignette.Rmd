...
cbmc.rna <- as.sparse(read.csv(file = '/brahms/hartmana/seurat_site_builder/seurat5/seurat-private/data/GSE100866_CBMC_8K_13AB_10X-RNA_umi.csv.gz', sep = ',', header = TRUE, row.names = 1))
...
cbmc.adt <- as.sparse(read.csv(file = '/brahms/hartmana/seurat_site_builder/seurat5/seurat-private/data/GSE100866_CBMC_8K_13AB_10X-ADT_umi.csv.gz', sep = ',', header = TRUE, row.names = 1))
