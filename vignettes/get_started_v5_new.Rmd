...
process_entry <- function(dat) {
  if (grepl(pattern = "assets/", x= dat$image)) {
...
We provide a series of vignettes, tutorials, and analysis walkthroughs to help users get started with Seurat. 

You can refer to the documentation for Seurat functions [here](../reference/index.html).
