...
inputdata.10x <- Read10X_h5("../data/pbmc_cellranger_arc_2/pbmc_granulocyte_sorted_10k_filtered_feature_bc_matrix.h5")
...
frag.file <- "../data/pbmc_cellranger_arc_2/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz"
...
```{r pbmc.ref}
obj.rna <- LoadH5Seurat("../data/pbmc_multimodal.h5seurat")
```
<details>
