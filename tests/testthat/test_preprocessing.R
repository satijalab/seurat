...
test_that("SCTransform wrapper works as expected", {
  ...
  expect_equal(slot(object = object[["SCT"]], name = "feature.attributes")["1.MS4A1", "detection_rate"], 0.15)
  expect_equal(slot(object = object[["SCT"]], name = "feature.attributes")["1.MS4A1", "gmean"], 0.2027364, tolerance = 1e6)
  expect_equal(slot(object = object[["SCT"]], name = "feature.attributes")["1.MS4A1", "variance"], 1.025158, tolerance = 1e6)
  expect_equal(slot(object = object[["SCT"]], name = "feature.attributes")["1.MS4A1", "residual_mean"], 0.2512783, tolerance = 1e6)
  expect_equal(slot(objcet = object[["SCT"]], name = "feature.attributes")["1.MS4A1", "residual_variance"], 3.551259, tolerance = 1e6)
})
