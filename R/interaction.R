...
#' pbmc1 <- SubsetData(object = pbmc_small, cell.names = pbmc_small@cell.names[1:40])
#' pbmc1
#' pbmc2 <- SubsetData(object = pbmc_small, cell.names = pbmc_small@cell.names[41:80])
#' pbmc2
#' # Merge pbmc1 and pbmc2 into one Seurat object
#' pbmc_merged <- MergeSeurat(object1 = pmbc1, object2 = pbmc2)
#' pbmc_merged
#'
