...
write_matrix_dir(mat = brain.data, dir = '/brahms/hartmana/vignette_data/bpcells/brain_counts', overwrite = TRUE)
...
```{r}
saveRDS(brain, file = "obj.Rds", destdir = "/brahms/hartmana/vignette_data/bpcells/brain_object")
```
...
for (i in 1:length(files.set)) {
  ...
  write_matrix_dir(mat = data, dir = paste0(file.dir, 
                                            gsub(".h5ad", "", path), 
                                            "_BP"), overwrite = TRUE)
  # Load in BP matrices
  mat <- open_matrix_dir(dir = paste0(file.dir, 
                                            gsub(".h5ad", "", path), "_BP"))
...
```{r save_merged}
saveRDS(merged.object, file = "obj.Rds", destdir = "/brahms/hartmana/vignette_data/bpcells/merged_object")
```
...
```{r save_parse}
saveRDS(parse.object, file = "obj.Rds", destdir = "/brahms/hartmana/vignette_data/bpcells/parse_object")
```
