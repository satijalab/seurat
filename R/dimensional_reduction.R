...
#' @param rescale Rescale the datasets prior to CCA. If FALSE, uses existing data in the scale data layers
...
#' @param layer The layer used to pull data for when using \code{features}. data layer is by default.
