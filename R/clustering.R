...
MultiModalNN.umap <- function(object, 
                         query = NULL,
                         k.nn = 20, 
                         reduction.list,
                         dims.list = NULL,
...
FindMultiModelNeighbors.umap <-  function(object, 
                                     modality.weight = NULL,
                                     prune.SNN = 1/20, 
                                     knn.graph.name = "jknn",
                                     snn.graph.name = "jsnn",
  ...
  joint.nn <- MultiModalNN.umap(object = object, 
...
FindModalityWeights.umap     <- function(object, 
                                    reduction.list, 
                                    dims.list, 
                                    snn.far.nn = TRUE, 
                                    k.nn = 20, 
