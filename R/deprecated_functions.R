...
#'   \code{find_all_markers_node} \tab now a synonym for \code{\link{FindAllMarkersNode}}\cr
...
find_all_markers_node <- function(...) {
    .Deprecated("FindAllMarkersNode", package="Seurat")
    FindAllMarkersNode(...)
}
