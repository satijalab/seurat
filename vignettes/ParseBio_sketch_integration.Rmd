...
library(ggplot2)
plot <- DoHeatmap(bulk, features = top5$gene) + NoLegend() + theme(axis.text.y = element_blank())
ggsave(filename = "../output/images/ParseBio_sketch_integration.jpg", height = 7, width = 7, plot = plot, quality = 50)
```
