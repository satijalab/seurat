...
CanonCor <- function(mat1, mat2, center = TRUE) {
    .Call('Seurat_CanonCor', PACKAGE = 'Seurat', mat1, mat2, center)
}
...
FastCov <- function(mat) {
    .Call('Seurat_FastCov', PACKAGE = 'Seurat', mat)
}

FastCovMats <- function(mat1, mat2) {
    .Call('Seurat_FastCovMats', PACKAGE = 'Seurat', mat1, mat2)
}
