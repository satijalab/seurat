...
|----------|-----------|-----------|-------|
| `multicore` | Linux/macOS (Unix-alikes) — **not** Windows, and not supported inside RStudio | Forks the current process; workers share memory, so nothing is serialized | Fast; the recommended path where available |
