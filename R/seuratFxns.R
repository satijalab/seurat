...
doModularity_Clust=function(SNN=matrix(), modularity=1, resolution=1.0, algorithm=1, n_start=1000, n_iter=10, random_seed=0, print_output=1,ModularityJarFile="ModularityOptimizer.jar"){
  diag(SNN)=0
