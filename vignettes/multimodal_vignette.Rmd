...
* Defining cellular identity from multimodal data using WNN analysis in Seurat v4 [vignette link](weighted_nearest_neighbor_analysis.html)
* Mapping scRNA-seq data onto CITE-seq references [vignette link](reference_mapping.html)
* Introduction to the analysis of spatial transcriptomics analysis [vignette link](spatial_vignette.html)
* Analysis of 10x multiome (paired scRNA-seq + ATAC) using WNN analysis [vignette link](weighted_nearest_neighbor_analysis.html)
* Signac: Analysis, intepretation, and exploration of single-cell chromatin datasets [package link](https://satijalab.org/signac/)
* Mixscape: an analytical toolkit for pooled single-cell genetic screens [vignette link](mixscape_vignette.html)
