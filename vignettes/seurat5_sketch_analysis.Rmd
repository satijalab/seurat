...
To run this vignette please install Seurat v5, using the installation instructions found [here](https://satijalab.org/seurat/articles/install.html). Additionally, you will need to install the `BPcells` package, using the installation instructions found [here](https://bnprks.github.io/BPCells/#installation).
...
FeaturePlot(obj, c('Igfbp7', 'Neurod6', 'Dlx2','Gad2', 'Eomes', 'Vim', 'Reln', 'Olig1', 'C1qa'), ncol = 3)
```
...
```{r,fig.height = 7, fig.width = 10}
FeaturePlot(obj.sub, c('Dlx2', 'Gad2', 'Lhx6', 'Nr2f2', 'Sst', 'Pvalb', 'Meis2', 'Vip', 'Dlx6os1'), ncol = 3)
```
