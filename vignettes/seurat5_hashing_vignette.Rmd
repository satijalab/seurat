...
FeatureScatter(pbmc.hashtag, feature1 = 'hto_HTO_A', feature2 = 'hto_HTO_B')
```
...
hto12.umis <- readRDS("/brahms/hartmana/seurat_site_builder/seurat/data/hto12_umi_mtx.rds")

# Read in HTO count matrix
hto12.htos <- readRDS("/brahms/hartmana/seurat_site_builder/seurat/data/hto12_hto_mtx.rds")
