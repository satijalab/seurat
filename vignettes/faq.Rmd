...
* **Integrated analysis of scRNA-seq datasets**
    * Seurat v3 implements new methods to identify 'anchors' across single-cell datasets ([Stuart\*, Butler\* et al., bioRxiv, 2018](https://www.biorxiv.org/content/10.1101/460147v1)). The procedure significantly extends our previous 'alignment' methods in Seurat v2 ([Butler et al, Nature Biotechnology, 2018](https://www.nature.com/articles/nbt.4096)). To guide users, we include the following vignettes, with additional tutorials forthcoming:
...
* **New methods for the normalization and scaling of single-cell data**
    * Seurat v3 includes a workflow that implements 'regularized negative binomial regression' for the normalization and variance stabilization of single-cell data, as described in our sctransform preprint ([Hafemeister and Satija, bioRxiv 2019](https://www.biorxiv.org/content/10.1101/576827v1)). The method has a few attractive properties when compared to log-normalization:
...
* [Stuart\*, Butler\* et al., bioRxiv, 2018](https://www.biorxiv.org/content/10.1101/460147v1)
 ...
 * [Hafemeister and Satija, bioRxiv 2019](https://www.biorxiv.org/content/10.1101/576827v1)
