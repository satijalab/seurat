...
test_that("IntegrateData with two objects default work", {
  ...
  expect_equal(sum(GetAssayData(int2[["integrated"]])[1, ]), 45.0264745797, tolerance = 1e-6)
...
test_that("IntegrateData with three objects default work", {
  ...
  expect_equal(sum(GetAssayData(int3[["integrated"]])[1, ]), 373.10769806, tolerance = 1e-6)
