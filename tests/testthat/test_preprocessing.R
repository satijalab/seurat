...
test_that("SCTransform wrapper works as expected", {
  ...
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.gmean"], 0.2027364, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.variance"], 1.025158, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.residual_mean"], 0.2362887026, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.residual_variance"], 2.875760656, tolerance = 1e-6)
})
...
test_that("SCTransform ncells param works", {
  ...
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.gmean"], 0.2027364, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.variance"], 1.025158, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.residual_mean"], 0.3084931639, tolerance = 1e-6)
  expect_equal(object[["SCT"]][[]]["MS4A1", "sct.residual_variance"], 3.721067314, tolerance = 1e-6)
})
