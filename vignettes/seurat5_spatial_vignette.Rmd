...
```{r sc.data}
allen_reference <- readRDS("/home/hartmana/github/seurat-private/data/allen_cortex.rds")
...
```{r ref.saunders}
ref <- readRDS("/home/hartmana/github/seurat-private/data/mouse_hippocampus_reference.rds")
...
```{r rctd, warning=FALSE, results=FALSE}
library(spacexr)
