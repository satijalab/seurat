...
* There are a large number of datasets or cells to integrate (see [here](https://satijalab.org/seurat/articles/integration_large_datasets.html) for more tips on integrating large datasets)
