...
```{r,fig.width=10, fig.height=5}
p1 <- DimPlot(object, reduction = 'umap.full', group.by = 'sample',alpha = 0.1) + NoLegend()
p2 <- DimPlot(object, reduction = 'umap.full', group.by = 'celltype.manual', label = T, alpha = 0.1) + NoLegend()
p1 + p2
```
