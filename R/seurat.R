...
#' associated with the dataset, including data, annotations, analyses, etc. All that is needed
...
#' @slot scale.data scaled (default is z-scoring each gene) expression matrix; used for dimensional reduction and heatmap visualization
...
#' @slot misc Miscellaneous spot to store any data alongside the object (for example, gene lists)
