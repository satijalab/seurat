...
As a demonstration, we will use a subset of technologies to construct a reference. We will then map the remaining datasets onto this reference. We start by selecting cells from two technologies, and performing an analysis without integration.
...
write.csv(df, "/brahms/jiangl/vignette_render_times/chunk_times_integration_mapping.csv", row.names = FALSE)
