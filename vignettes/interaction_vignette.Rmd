...
nk.raw.data <- as.matrix(GetAssayData(pbmc, layer = 'counts')[, WhichCells(pbmc, ident = "NK")])
...
# First, replace spaces with underscores '-' so ggplot2 doesn't fail
orig.levels <- levels(pbmc)
Idents(pbmc) <- gsub(pattern = ' ', replacement = '-', x = Idents(pbmc))
...
CellScatter(cluster.averages, cell1 = "NK", cell2 = "CD8-T")
...
CellScatter(cluster.averages, cell1 = "CD8-T_rep1", cell2 = "CD8-T_rep2")
