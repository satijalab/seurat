...
pbmc3k.final[["RNA"]] <- CreateAssay5Object(counts=pbmc3k.final[["RNA"]]@counts)
pbmc3k.final <- NormalizeData(pbmc3k.final)
DefaultLayer(pbmc3k.final[["RNA"]]) <- "counts"
pbmc3k.final <- FindVariableFeatures(pbmc3k.final)
DefaultLayer(pbmc3k.final[["RNA"]]) <- "data"
...
write.csv(x = t(as.data.frame(all_times)), file = "../output/timings/seurat5_visualization_vignette_times.csv")
```
